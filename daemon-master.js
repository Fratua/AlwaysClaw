...
const COGNITIVE_LOOP_SCHEDULES = [
  ...
  { name: 'research', method: 'loop.research.run_cycle', cron: '*/15 * * * *' },
  { name: 'planning', method: 'loop.planning.run_cycle', cron: '*/10 * * * *' },
  { name: 'e2e', method: 'loop.e2e.run_cycle', cron: '*/10 * * * *' },
  { name: 'exploration', method: 'loop.exploration.run_cycle', cron: '*/30 * * * *' },
  { name: 'discovery', method: 'loop.discovery.run_cycle', cron: '*/30 * * * *' },
  { name: 'bug_finder', method: 'loop.bug_finder.run_cycle', cron: '*/15 * * * *' },
  { name: 'self_learning', method: 'loop.self_learning.run_cycle', cron: '0 * * * *' },
  { name: 'meta_cognition', method: 'loop.meta_cognition.run_cycle', cron: '0 * * * *' },
  { name: 'self_upgrading', method: 'loop.self_upgrading.run_cycle', cron: '0 3 * * *' },
  { name: 'self_updating', method: 'loop.self_updating.run_cycle', cron: '0 4 * * *' },
  { name: 'self_driven', method: 'loop.self_driven.run_cycle', cron: '*/30 * * * *' },
  { name: 'cpel', method: 'loop.cpel.run_cycle', cron: '0 * * * *' },
